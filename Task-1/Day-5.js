...
let b={
        ...
        titles:['Princess of Winterfell','Lady of Winterfell','Queen in the North'],
        status:'Alive',
        age:20,
        DOB:'285 AC',
        death:'NA',
        ...
        getBio(){
            return `Lady ${this.getFullName()} [birth: ${this.DOB}] was the ${this.titles[0]} and thus the head of ${this.allegiance.birth} of ${this.origin} ever since the death of her mother, ${this.mother}. She pledged ${this.allegiance.birth} forces to ${this.allegiance.oath} upon meeting Jon Snow, Sansa Stark, and Davos Seaworth, making her house one of the few loyalists to fight for the Starks against House Bolton at the Battle of the Bastards. She was killed in ${this.death} at the age of ${this.age}.`
        },
        getCharacterInfo(){
            return `We are introduced to ${this.getFullName()} in '${this.firstSeen}' as the ${this.titles[0]}, successor of ${this.predecessor} who was also her mother. She is last seen in '${this.latestEpi}' fighting alongside ${this.allegiance.death}. She was buried as per her religion ${this.religion}.`
        },
        getActressInfo(){
